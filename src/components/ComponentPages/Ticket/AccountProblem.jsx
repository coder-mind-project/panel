...
import { Grid, Box, Icon, Divider, Button, TextField } from '@material-ui/core' 
...
class AccountProblem extends Component {
    ...
    async sendTicket(){
        ...
        const url = `${backendUrl}/tickets/authenticated`
...
export default connect(mapStateToProps)(AccountProblem)