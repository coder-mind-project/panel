...
import {Button, Icon, makeStyles, useMediaQuery} from '@material-ui/core'
...
export default (props) => {
    ...
    return (
        <Button className={classes[props.color] || classes.default}
                ...
                >
            {!props.disableIcon && <Icon fontSize={props.iconSize || 'default'} className={classes.icon}>{props.icon}</Icon>}{props.text}
        </Button>
    )
}